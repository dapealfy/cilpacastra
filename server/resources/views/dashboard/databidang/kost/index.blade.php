...
<div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
    <h3 class="content-header-title mb-0 d-inline-block">Data Bidang Kost</h3>
    <div class="row breadcrumbs-top d-inline-block">
        <div class="breadcrumb-wrapper col-12">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/dashboard">Home</a>
                </li>
                <li class="breadcrumb-item active">Data Bidang Kost
                </li>
            </ol>
        </div>
    </div>
...
<div class="content-header-right col-md-6 col-12">
    <div class="btn-group float-md-right">
        ...
        <button class="btn btn-info rounded-0 mb-1" id="createDataBidangKostButton" type="button">Tambah</button>
    </div>
</div>
@endsection
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">List Data Bidang Kost</h4>
            ...
            <div class="card-content collapse show">
                <div class="card-body card-dashboard">
                    <table class="table table-striped table-bordered zero-configuration datatable">
                        ...
                        <tbody>
                            @php $no = 1; @endphp
                            @foreach($databidang_kost as $item)
                            <tr>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" style="min-width: 9rem !important">
                                            <button class="dropdown-item editDataBidangKostButton" value="{{ $item->id }}">
                                                <i class="la la-edit"></i> Ubah
                                            </button>
                                            <button class="dropdown-item deleteDataBidangKostButton" value="{{ $item->id }}">
...
<div class="modal fade" id="createDataBidangKostModal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header btn-info white">
                <h4 class="modal-title white">Tambah Data Bidang Kost</h4>
                <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <form action="{{ route('databidang-kost.store') }}" method="post">
...
<div class="modal fade" id="editDataBidangKostModal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header btn-info white">
                <h4 class="modal-title white">Ubah Kost</h4>
                <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <form action="" id="editDataBidangKostForm" method="post">
                <div class="modal-body">
                    @csrf
                    @method("PUT")
                    <div class="form-group">
...
<div class="modal fade" id="deleteDataBidangKostModal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="" id="deleteDataBidangKostForm" method="post">
                <div class="modal-footer">
                    @csrf
                    @method("DELETE")
                    <button type="button" class="btn grey btn-outline-secondary" data-dismiss="modal">Kembali</button>
...
<div class="modal fade" id="importExcel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form method="post" action="/databidang-kost-import" enctype="multipart/form-data">
            <div class="modal-content">
                <div class="modal-header bg-info white">
...
@section('script')
<script>
    $(document).on("click", "#createDataBidangKostButton", function() {
        $("#createDataBidangKostModal").modal();
    });

    $(document).on("click", ".editDataBidangKostButton", function() {
        let id = $(this).val();
        $.ajax({
            method: "GET",
            url: "{{ route('databidang-kost.index') }}/" + id + "/edit"
            ...
            $("#editDataBidangKostForm").attr("action", "{{ route('databidang-kost.index') }}/" + id)
            $("#editDataBidangKostModal").modal();
        })
    });

    $(document).on("click", ".deleteDataBidangKostButton", function() {
        let id = $(this).val();

        $("#deleteDataBidangKostForm").attr("action", "{{ route('databidang-kost.index') }}/" + id)
        $("#deleteDataBidangKostModal").modal();
    });
</script>
@endsection