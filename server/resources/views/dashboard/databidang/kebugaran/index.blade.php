...
<div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
    <h3 class="content-header-title mb-0 d-inline-block">Data Bidang Panti Kebugaran</h3>
    <div class="row breadcrumbs-top d-inline-block">
        <div class="breadcrumb-wrapper col-12">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/dashboard">Home</a>
                </li>
                <li class="breadcrumb-item active">Data Panti Kebugaran
                </li>
            </ol>
        </div>
    </div>
...
<div class="content-header-right col-md-6 col-12">
    <div class="btn-group float-md-right">
        ...
        <button class="btn btn-info rounded-0 mb-1" id="createDataBidangKebugaranButton" type="button">Tambah</button>
    </div>
</div>
@endsection
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">List Data Bidang Panti Kebugaran</h4>
            ...
            <div class="card-content collapse show">
                <div class="card-body card-dashboard">
                    <table class="table table-striped table-bordered zero-configuration datatable">
                        ...
                        <tbody>
                            @php $no = 1; @endphp
                            @foreach($databidang_kebugaran as $item)
                            <tr>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" style="min-width: 9rem !important">
                                            <button class="dropdown-item editDataBidangKebugaranButton" value="{{ $item->id }}">
                                                <i class="la la-edit"></i> Ubah
                                            </button>
                                            <button class="dropdown-item deleteDataBidangKebugaranButton" value="{{ $item->id }}">
                        ...
                        <!-- <tfooter>
                            <tr>
                                <th colspan="4">Rekap Kebugaran</th>
                                <th>Total Kamar</th>
                                <th>Username</th>
                                <th>Username</th>
                                <th>Username</th>
...
<div class="modal fade" id="createDataBidangKebugaranModal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header btn-info white">
                <h4 class="modal-title white">Tambah Data Bidang Kebugaran</h4>
                <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <form action="{{ route('databidang-kebugaran.store') }}" method="post">
...
<div class="modal fade" id="editDataBidangKebugaranModal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header btn-info white">
                <h4 class="modal-title white">Ubah Kebugaran</h4>
                <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <form action="" id="editDataBidangKebugaranForm" method="post">
                <div class="modal-body">
                    @csrf
                    @method("PUT")
                    <div class="form-group">
...
<div class="modal fade" id="deleteDataBidangKebugaranModal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="" id="deleteDataBidangKebugaranForm" method="post">
                <div class="modal-footer">
                    @csrf
                    @method("DELETE")
                    <button type="button" class="btn grey btn-outline-secondary" data-dismiss="modal">Kembali</button>
...
<div class="modal fade" id="importExcel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form method="post" action="/databidang-kebugaran-import" enctype="multipart/form-data">
            <div class="modal-content">
                <div class="modal-header bg-info white">
...
@section('script')
<script>
    $(document).on("click", "#createDataBidangKebugaranButton", function() {
        $("#createDataBidangKebugaranModal").modal();
    });

    $(document).on("click", ".editDataBidangKebugaranButton", function() {
        let id = $(this).val();
        $.ajax({
            method: "GET",
            url: "{{ route('databidang-kebugaran.index') }}/" + id + "/edit"
            ...
            $("#editDataBidangKebugaranForm").attr("action", "{{ route('databidang-kebugaran.index') }}/" + id)
            $("#editDataBidangKebugaranModal").modal();
        })
    });

    $(document).on("click", ".deleteDataBidangKebugaranButton", function() {
        let id = $(this).val();

        $("#deleteDataBidangKebugaranForm").attr("action", "{{ route('databidang-kebugaran.index') }}/" + id)
        $("#deleteDataBidangKebugaranModal").modal();
    });
</script>
@endsection