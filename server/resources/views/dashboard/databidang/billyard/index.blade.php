...
<div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
    <h3 class="content-header-title mb-0 d-inline-block">Data Bidang Billyard</h3>
    <div class="row breadcrumbs-top d-inline-block">
        <div class="breadcrumb-wrapper col-12">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/dashboard">Home</a>
                </li>
                <li class="breadcrumb-item active">Data Billyard
                </li>
            </ol>
        </div>
    </div>
...
<div class="content-header-right col-md-6 col-12">
    <div class="btn-group float-md-right">
        ...
        <button class="btn btn-info rounded-0 mb-1" id="createDataBidangBillyardButton" type="button">Tambah</button>
    </div>
</div>
@endsection
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">List Data Bidang Billyard</h4>
            ...
            <div class="card-content collapse show">
                <div class="card-body card-dashboard">
                    <table class="table table-striped table-bordered zero-configuration datatable">
                        ...
                        <tbody>
                            @php $no = 1; @endphp
                            @foreach($databidang_billyard as $item)
                            <tr>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" style="min-width: 9rem !important">
                                            <button class="dropdown-item editDataBidangBillyardButton" value="{{ $item->id }}">
                                                <i class="la la-edit"></i> Ubah
                                            </button>
                                            <button class="dropdown-item deleteDataBidangBillyardButton" value="{{ $item->id }}">
                        ...
                        <!-- <tfooter>
                            <tr>
                                <th colspan="4">Rekap Billyard</th>
                                <th>Total Kamar</th>
                                <th>Username</th>
                                <th>Username</th>
                                <th>Username</th>
...
<div class="modal fade" id="createDataBidangBillyardModal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header btn-info white">
                <h4 class="modal-title white">Tambah Data Bidang Billyard</h4>
                <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <form action="{{ route('databidang-billyard.store') }}" method="post">
...
<div class="modal fade" id="editDataBidangBillyardModal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header btn-info white">
                <h4 class="modal-title white">Ubah Billyard</h4>
                <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <form action="" id="editDataBidangBillyardForm" method="post">
                <div class="modal-body">
                    @csrf
                    @method("PUT")
                    <div class="form-group">
...
<div class="modal fade" id="deleteDataBidangBillyardModal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="" id="deleteDataBidangBillyardForm" method="post">
                <div class="modal-footer">
                    @csrf
                    @method("DELETE")
                    <button type="button" class="btn grey btn-outline-secondary" data-dismiss="modal">Kembali</button>
...
<div class="modal fade" id="importExcel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form method="post" action="/databidang-billyard-import" enctype="multipart/form-data">
            <div class="modal-content">
                <div class="modal-header bg-info white">
...
@section('script')
<script>
    $(document).on("click", "#createDataBidangBillyardButton", function() {
        $("#createDataBidangBillyardModal").modal();
    });

    $(document).on("click", ".editDataBidangBillyardButton", function() {
        let id = $(this).val();
        $.ajax({
            method: "GET",
            url: "{{ route('databidang-billyard.index') }}/" + id + "/edit"
            ...
            $("#editDataBidangBillyardForm").attr("action", "{{ route('databidang-billyard.index') }}/" + id)
            $("#editDataBidangBillyardModal").modal();
        })
    });

    $(document).on("click", ".deleteDataBidangBillyardButton", function() {
        let id = $(this).val();

        $("#deleteDataBidangBillyardForm").attr("action", "{{ route('databidang-billyard.index') }}/" + id)
        $("#deleteDataBidangBillyardModal").modal();
    });
</script>
@endsection