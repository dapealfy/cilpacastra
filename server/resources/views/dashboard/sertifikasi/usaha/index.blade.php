...
@section('title', 'Sertifikasi Usaha')
...
<div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
    <h3 class="content-header-title mb-0 d-inline-block">Sertifikasi Usaha</h3>
    <div class="row breadcrumbs-top d-inline-block">
        <div class="breadcrumb-wrapper col-12">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/dashboard">Home</a>
                </li>
                <li class="breadcrumb-item active">Sertifikasi Usaha
                </li>
            </ol>
        </div>
    </div>
            ...
            <div class="card-content collapse show">
                <div class="card-body card-dashboard">
                    <table class="table table-striped table-bordered table-responsive zero-configuration datatable">
                        ...
                        <tbody>
                            @php $no = 1; @endphp
                            @foreach($sertifikasi_usaha as $item)
                            <tr>
                                <td class="text-capitalize">{{ $no++ }}</td>
                                <td class="text-capitalize">{{ $item->nama_klien }}</td>
                                <td>{{ $item->permohonan }}</td>
                                <td>{{ $item->kajian }}</td>
                                <td>{{ $item->perjanjian }}</td>
                                <td>{{ $item->lap_audit_s2 }}</td>
                                <td>{{ $item->sertifikat }}</td>
                                <td>{{ $item->lap_audit_sury }}</td>
                                <td>{{ $item->klasifikasi_bintang }}</td>
                                <td>{{ $item->lsu_auditor }}</td>
                                <td>
                                    <div class="dropdown">
