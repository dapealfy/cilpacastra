...
class CreateDataBidangKebugaransTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('data_bidang_kebugarans', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('data_bidang_kebugarans');
    }
}
