...
class CreateDataBidangBioskopsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('data_bidang_bioskops', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('data_bidang_bioskops');
    }
}
