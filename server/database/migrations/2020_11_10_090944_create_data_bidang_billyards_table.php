...
class CreateDataBidangBillyardsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('data_bidang_billyards', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('data_bidang_billyards');
    }
}
